...
export const register = createAsyncThunk(
  ...
  async (userData, { rejectWithValue }) => {
    try {
      ...
      if (!userData.region || !userData.prefecture || !userData.commune || !userData.quartier || !userData.address || !userData.latitude || !userData.longitude) {
        throw new Error('Veuillez sélectionner votre localisation complète et remplir votre adresse avec coordonnées');
      }
