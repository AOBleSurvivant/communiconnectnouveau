...
class PushNotificationService {
  ...
  checkSupport() {
    return 'serviceWorker' in navigator && 'PushManager' in window && this.messaging;
  }
  ...
  async getFCMToken() {
    try {
      const token = await getToken(this.messaging, {
        vapidKey: process.env.REACT_APP_FIREBASE_VAPID_KEY || 'BLBz...' // À remplacer par votre clé VAPID
      });
      return token;
    } catch (error) {
